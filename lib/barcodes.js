 ...
 */
barcodeHelper.getLibraryBarcode = (error,customer) => new Promise((resolves,rejects) => {
 ...
 */
barcodeHelper.replenishBarcodeDatabase = (error,barcodeList) => new Promise((resolves,rejects) => {
