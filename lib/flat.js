...
/**
 * A status object which has an array of flat data which could be
 * empty if there was a problem, and an array of errors, 
 * which could be empty if there weren't any.
 */
flat.status = {
    errors: [],
    flat: []
