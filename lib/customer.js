...
customerHelper.validate = (custErr,customer,partnerConfig) => new Promise((resolves, rejects) => {
  ...
  // Get the required list from the partner organization object.
  // if (helpers.hasArrayData(partnerConfig)){
  //   throw new Error('Expected partner.json data, but it was empty or null.');
  // }
