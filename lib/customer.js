...
customerHelper._getFromDefault = function(str,partnerConfig){
  ...
  if (utils.hasDictData(partnerConfig) && utils.hasDictData(partnerConfig.defaults)){
  ...
  if (utils.hasDictData(librarySettings) && utils.hasDictData(librarySettings.defaults)){
