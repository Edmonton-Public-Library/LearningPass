 ...
 */
customerHelper.createAccount = (custErr,apiKey,rawData) => new Promise((resolve,reject) => {
 ...
 */
customerHelper.validate = (custErr,customer,partnerConfig) => new Promise((resolves, reject) => {
  if (!custErr){
